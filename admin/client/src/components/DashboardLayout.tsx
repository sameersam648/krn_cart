...
import { LayoutDashboard, LogOut, PanelLeft, Users, Store, Bike, ShoppingCart, Utensils, Settings, Bell } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Utensils, label: "Categories", path: "/categories" },
